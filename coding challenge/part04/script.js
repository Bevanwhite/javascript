...
In his country, it's usual to tip 15% if the bill value is 
...
const bill = Number(prompt('Enter the number?'))
// console.log(bill);

const totalBill = bill > 300 ? (tip = bill * 0.2) + bill : (tip = bill * 0.15) + bill;
